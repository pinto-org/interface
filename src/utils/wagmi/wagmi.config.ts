    ...
    contracts: [
      ...
      },
      {
        ...
        address: {
          ...
          [base.id]: "0xA1F486Cf4A5739EF4277755C1d8A96B2039d8F8f", // temp address
          [localhost.id]: "0xA1F486Cf4A5739EF4277755C1d8A96B2039d8F8f", // base
          [TESTNET_CHAIN_ID]: "0xA1F486Cf4A5739EF4277755C1d8A96B2039d8F8f", // base
          [foundry.id]: "0xA1F486Cf4A5739EF4277755C1d8A96B2039d8F8f", // base
        },
      },
      {
        name: "pipeline",
