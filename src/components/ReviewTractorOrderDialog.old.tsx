...
type ReviewConvertUpOrderV0Props = {
  something: string;
  tokenStrategy?: "LOWEST_SEEDS" | "LOWEST_PRICE" | "SPECIFIC_TOKEN" | "MULTI_TOKENS";
  operatorTip: string;
} & {
  blueprintType: "ConvertUp";
};

type ReviewTractorOrderType = "Sow" | "ConvertUp";

type DynamicOrderTypeProps = {
  blueprintType: ReviewTractorOrderType;
};

type ReviewTractorOrderProps = {
  open: boolean;
  ...
  orderData: ReviewSowOrderV0Props;
};

export default function ReviewTractorOrderDialog2({
  open,
  onOpenChange,
  onSuccess,
  onOrderPublished,
