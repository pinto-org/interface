...
const WalletButton = forwardRef<HTMLButtonElement, WalletButtonProps>(
  ({ isOpen = false, togglePanel, className }, ref) => {
    ...
    const walletAddress = isPrivateMode
      ? obfuscatedWalletAddress
      : address && `${truncateAddress(address, { suffix: !isTablet, letters: isTablet ? 3 : undefined })}`;
      ...
      <Panel
        ...
        trigger={
          ...
          >
            ...
            <>{ensName ? ensName : address ? walletAddress : "Connect"}</>
