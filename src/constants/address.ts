...
export const TRACTOR_HELPERS_ADDRESS: HashString = "0x53B7cF2a4A18062aFF4fA71Bb300F6eA2d3702E2";

export const SILO_HELPERS_ADDRESS: HashString = "0xe02919865F7ea6F342F09538BE801ee4a14884CD";

export const SOW_BLUEPRINT_V0_ADDRESS: HashString = "0xbb0a41927895F8ca2b4ECCc659ba158735fCF28B";

export const CONVERT_UP_BLUEPRINT_V0_ADDRESS: HashString = "0x17C0FE752979b613b21ddD30bc75037C23280cB0";

export const SOW_BLUEPRINT_V0_SELECTOR = "0x3ca8e1b2" as const;

export const CONVERT_UP_BLUEPRINT_V0_SELECTOR = "0xaeebd84a" as const;
