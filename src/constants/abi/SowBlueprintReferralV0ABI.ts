export const sowBlueprintReferralV0ABI = [
  {
    inputs: [
      {
  ...
  },
  {
    ...
    outputs: [
      {
        internalType: "contract SiloHelpers",
        name: "",
        type: "address",
      },
    ],
    ...
    inputs: [
      {
            ...
            components: [
              {
                components: [
                  ...
                  },
                  {
                    ...
                    internalType: "struct SowBlueprintBase.SowAmounts",
                    name: "sowAmounts",
                    type: "tuple",
                  },
                  {
                ...
                internalType: "struct SowBlueprintBase.SowParams",
                name: "sowParams",
                type: "tuple",
              },
              {
                ...
                internalType: "struct SowBlueprintBase.OperatorParams",
                name: "opParams",
                type: "tuple",
              },
            ],
            internalType: "struct SowBlueprintBase.SowBlueprintStruct",
            name: "params",
            type: "tuple",
          },
          {
        ...
        internalType: "struct SowBlueprintReferral.SowReferralBlueprintStruct",
        name: "params",
        type: "tuple",
      },
    ],
    name: "sowBlueprintReferral",
    outputs: [],
  ...
  },
  {
    ...
    outputs: [
      {
        internalType: "contract TractorHelpers",
        name: "",
        type: "address",
      },
    ],
