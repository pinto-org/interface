...
const createSiloCharts = (mainToken: Token): ChartSetupBase[] => [
  ...
  {
    id: "convertUpBonusCapacityUsedLastSeason",
    type: "Silo",
    name: "Convert Up Bonus Capacity Used Last Season",
    tooltipTitle: "Convert Up Bonus Capacity Used Last Season",
    tooltipHoverText: "Amount of PDV that Pinto has issued a Stalk bonus to last Season.",
    shortDescription: "Convert Up Bonus Capacity Used Last Season",
    icon: stalkIcon,
    timeScaleKey: "timestamp",
    priceScaleKey: "convertUpBonusCapacityUsedLastSeason",
    valueAxisType: "convertUpBonusCapacityUsedLastSeason",
    valueFormatter: (v: TokenValue) => v.toNumber(),
    tickFormatter: (v: number) =>
      formatNum(v, { allowZero: true, minDecimals: 2, maxDecimals: 2, showPositiveSign: false }),
    shortTickFormatter: (v: number) => TokenValue.fromHuman(v, 2).toHuman("short"),
